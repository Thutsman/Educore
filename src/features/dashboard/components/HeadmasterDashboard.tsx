import { GraduationCap, Banknote, ClipboardCheck, UserCog, AlertTriangle, CheckCircle2, Clock, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        {/* Fee collection radial + breakdown */}
